...
/// Contract-defined values for AIEvaluationAnswerBooleanType.
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub enum AIEvaluationAnswerBooleanType {
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct AIEvaluationAnswerBoolean {
    /// API field.
    pub id: String,
    /// API field.
    pub probability: f64,
    #[serde(rename = "type")]
    /// API field.
    pub type_: AIEvaluationAnswerBooleanType,
}

/// Contract-defined values for AIEvaluationAnswerChoiceType.
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub enum AIEvaluationAnswerChoiceType {
    /// The choice wire value.
    #[serde(rename = "choice")]
    Choice,
}
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct AIEvaluationAnswerChoice {
    /// API field.
    pub choice: String,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    /// API field.
    ...
    pub id: String,
    /// API field.
    pub probabilities: std::collections::BTreeMap<String, Value>,
    #[serde(rename = "type")]
    /// API field.
    pub type_: AIEvaluationAnswerChoiceType,
}

/// Contract-defined values for AIEvaluationAnswerScoreType.
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub enum AIEvaluationAnswerScoreType {
    /// The score wire value.
    #[serde(rename = "score")]
    Score,
}
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct AIEvaluationAnswerScore {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    /// API field.
    pub confidence: Option<f64>,
    /// API field.
    pub id: String,
    /// API field.
    pub legend: std::collections::BTreeMap<String, Value>,
    /// API field.
    pub probabilities: std::collections::BTreeMap<String, Value>,
    /// API field.
    pub score: f64,
    #[serde(rename = "type")]
    /// API field.
    pub type_: AIEvaluationAnswerScoreType,
}
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
#[serde(untagged)]
pub enum AIEvaluationAnswer {
    /// AIEvaluationAnswerBoolean union variant.
    AIEvaluationAnswerBoolean(AIEvaluationAnswerBoolean),
    /// AIEvaluationAnswerChoice union variant.
    AIEvaluationAnswerChoice(AIEvaluationAnswerChoice),
    /// AIEvaluationAnswerScore union variant.
    AIEvaluationAnswerScore(AIEvaluationAnswerScore),
}

/// Token counts for one evaluation request.
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct AIEvaluationUsage {
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct AIEvaluationResult {
    ...
    pub answers: Vec<AIEvaluationAnswer>,
    ...
    pub usage: Option<AIEvaluationUsage>,
}
...
pub struct AIImageResult {
    ...
    pub usage_attempt_count: Option<i64>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct Actor {
    ...
    pub profile_picture: Option<Option<ImageSource>>,
}
...
pub struct SolutionAutomationInvokeContract {
    ...
    pub input_schema: Option<Option<std::collections::BTreeMap<String, Value>>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    pub participants: Option<Option<Vec<AutomationParticipantSlot>>>,
...
pub struct SolutionAutomationTemplateDetails {
    ...
    pub automation_type: Option<Option<String>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    pub invoke_contract: Option<Option<SolutionAutomationInvokeContract>>,
    #[serde(rename = "type")]
...
pub struct SolutionTemplateSummary {
    ...
    pub details: Option<Option<SolutionTemplateDetails>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct SolutionSummary {
    ...
    pub installed_config_ids: Vec<String>,
    ...
    pub latest_solution: Option<Option<String>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    pub org_logo: Option<Option<ImageSource>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    pub template_kind: Option<Option<String>>,
...
pub struct Agent {
    ...
    pub last_applied_template_config: Option<Option<String>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    pub source_solution: Option<Option<AgentSourceSolution>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    pub template_upgrade_available: Option<Option<bool>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
/// Contract-defined values for SetupProtocolStatus.
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub enum SetupProtocolStatus {
    /// The not_checked wire value.
...
pub struct Setup {
    ...
    pub protocol_status: SetupProtocolStatus,
...
pub struct MediaVariant {
    ...
    pub image_source: Option<Option<ImageSource>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct User {
    ...
    pub org_role: Option<Option<String>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    pub sandbox_name: Option<Option<String>>,
}
...
/// Contract-defined values for CancelledStatus.
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
...
pub struct MessageContext {
    ...
    pub attributes: Option<std::collections::BTreeMap<String, Value>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
/// Contract-defined alternatives for MessageUser.
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
#[serde(untagged)]
...
pub struct Message {
    ...
    pub agent_mode: Option<Option<MessageAgentMode>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    pub user: Option<Option<MessageUser>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct Team {
    ...
    pub badges: Option<Option<std::collections::BTreeMap<String, Value>>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct ThreadSettings {
    ...
    pub agent_enabled: Option<Option<bool>>,
}
...
pub struct Thread {
    ...
    pub agent_user: Option<Option<String>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    pub creator: Option<Option<ThreadCreator>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    pub parent_message: Option<Option<Message>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    pub participating_agents: Option<Option<Vec<Agent>>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    pub sub_threads: Option<Option<Vec<std::collections::BTreeMap<String, Value>>>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct ChatLocalToolFunction {
    /// API field.
    pub description: String,
    /// API field.
    pub name: String,
...
/// Contract-defined values for ChatLocalToolDefinitionType.
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub enum ChatLocalToolDefinitionType {
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct ChatLocalToolDefinition {
    /// API field.
    pub function: ChatLocalToolFunction,
    #[serde(rename = "type")]
    /// API field.
    pub type_: ChatLocalToolDefinitionType,
}

/// Server-issued identity for the local-tool set currently advertised by this connection.
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct ChatLocalToolProvider {
    /// API field.
    pub generation: i64,
    /// API field.
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct ChatLocalToolRequest {
    /// API field.
    pub calls: Vec<ChatLocalToolCall>,
    /// API field.
    pub id: String,
}

/// Contract-defined values for OkStatus.
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub enum OkStatus {
    /// The ok wire value.
    #[serde(rename = "ok")]
...
/// Contract-defined values for ChatLocalToolResultErrorStatus.
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub enum ChatLocalToolResultErrorStatus {
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct ChatLocalToolResultError {
    /// API field.
    pub call_id: String,
    /// API field.
    pub code: String,
    ...
    pub message: String,
    /// API field.
    pub status: ChatLocalToolResultErrorStatus,
}

/// One terminal local-tool outcome returned by the owning client connection.
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ChatLocalToolResult {
    /// Ok union variant.
    Ok(Ok),
    /// ChatLocalToolResultError union variant.
    ChatLocalToolResultError(ChatLocalToolResultError),
    /// Cancelled union variant.
    Cancelled(Cancelled),
}
...
pub struct Command {
    ...
    pub error_output: Option<std::collections::BTreeMap<String, Value>>,
    #[serde(rename = "expectedInput")]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    /// JSON Schema describing the input the command expects. `null` if the command takes no input.
    pub expected_input: Option<std::collections::BTreeMap<String, Value>>,
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct EffectiveAccessBillingTrial {
    ...
    pub payment_method_stored: bool,
    /// Catalog plan whose trial is active.
    pub plan: String,
}

/// Contract-defined values for EffectiveAccessBillingPrincipalPrincipalType.
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub enum EffectiveAccessBillingPrincipalPrincipalType {
    /// The user wire value.
    #[serde(rename = "user")]
    User,
    /// The org wire value.
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct EffectiveAccessBillingPrincipal {
    /// Whether the authenticated user may administer this principal's billing account.
    pub administrator: bool,
    /// API field.
    pub principal_type: EffectiveAccessBillingPrincipalPrincipalType,
    /// Currently active trials for this Viewer-derived principal. Contains no billing-account or provider identifiers.
    pub trials: Vec<EffectiveAccessBillingTrial>,
}

/// Contract-defined values for EffectiveAccessEntitlementProvidedByItem.
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub enum EffectiveAccessEntitlementProvidedByItem {
    /// The personal wire value.
    #[serde(rename = "personal")]
    Personal,
    /// The organization wire value.
    #[serde(rename = "organization")]
    Organization,
}

/// Contract-defined values for EffectiveAccessEntitlementValueType.
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub enum EffectiveAccessEntitlementValueType {
    /// The boolean wire value.
    #[serde(rename = "boolean")]
    Boolean,
}
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct EffectiveAccessEntitlement {
    ...
    pub provided_by: Vec<EffectiveAccessEntitlementProvidedByItem>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    pub value_type: EffectiveAccessEntitlementValueType,
}
...
pub struct EffectiveAccess {
    ...
    pub billing: Vec<EffectiveAccessBillingPrincipal>,
    /// Requested catalog entitlements in request order.
    pub entitlements: Vec<EffectiveAccessEntitlement>,
}

/// Contract-defined values for CurrentUserOrgKind.
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub enum CurrentUserOrgKind {
    /// The company wire value.
...
pub struct CurrentUser {
    ...
    pub effective_access: Option<EffectiveAccess>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    /// Email address of the user.
    pub email: Option<Option<String>>,
    /// User ID (`usr_...`).
    ...
    pub notification_settings: std::collections::BTreeMap<String, Value>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    /// ID of the current organization (`org_...`).
    pub org: Option<Option<String>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    /// Whether the current organization is company-domain or person-owned.
    pub org_kind: Option<Option<CurrentUserOrgKind>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
/// Contract-defined values for D1DatabaseType.
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub enum D1DatabaseType {
    /// The d1_database wire value.
...
pub struct D1Database {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    /// API field.
    pub read_replication: Option<std::collections::BTreeMap<String, Value>>,
    #[serde(rename = "type")]
    /// API field.
    pub type_: D1DatabaseType,
}
...
/// Contract-defined values for R2BucketType.
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub enum R2BucketType {
    /// The r2_bucket wire value.
...
#[serde(untagged)]
pub enum Details {
    /// R2Bucket union variant.
    R2Bucket(R2Bucket),
    /// D1Database union variant.
...
/// Contract-defined values for EventSubscriptionStatus.
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub enum EventSubscriptionStatus {
    /// The active wire value.
    #[serde(rename = "active")]
    Active,
    /// The paused wire value.
    #[serde(rename = "paused")]
    Paused,
}
...
pub struct EventSubscription {
    ...
    /// API field.
    pub dropped_through_position: i64,
    /// API field.
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    /// API field.
    pub last_overflow_at: Option<chrono::DateTime<chrono::Utc>>,
    /// API field.
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct EventSubscriptionClaim {
    /// API field.
    pub data: Vec<EventSubscriptionDelivery>,
    /// API field.
    pub dropped_events_total: i64,
    /// API field.
    pub dropped_through_position: i64,
...
/// Contract-defined values for EventSubscriptionQueueEntryState.
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub enum EventSubscriptionQueueEntryState {
    /// The available wire value.
    #[serde(rename = "available")]
    Available,
    /// The leased wire value.
    #[serde(rename = "leased")]
    Leased,
}
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct EventSubscriptionQueueEntry {
    /// API field.
    pub delivery_id: String,
    /// API field.
    pub event: DomainEvent,
    ...
    pub sequence: i64,
    /// API field.
    pub state: EventSubscriptionQueueEntryState,
}

/// A non-reserving view of the queue head.
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct EventSubscriptionHead {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    /// API field.
    pub data: Option<EventSubscriptionQueueEntry>,
}
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct EventSubscriptionQueue {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    /// API field.
    pub after_cursor: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    pub before_cursor: Option<String>,
    /// API field.
    pub data: Vec<EventSubscriptionQueueEntry>,
    /// API field.
    pub dropped_events_total: i64,
    /// API field.
    pub dropped_through_position: i64,
...
pub struct ExpressionResult {
    ...
    pub output: Option<Vec<std::collections::BTreeMap<String, Value>>>,
...
pub struct ExpressionValidation {
    ...
    pub findings: Option<Vec<std::collections::BTreeMap<String, Value>>>,
    /// Whether the validation call succeeded
    pub ok: bool,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    /// Inferred symbol types at source positions (name, type, line, column)
    pub symbols: Option<Vec<std::collections::BTreeMap<String, Value>>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
/// Contract-defined values for ExternalObjectService.
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub enum ExternalObjectService {
    /// The cloudflare wire value.
...
pub struct ExternalObject {
    ...
    pub org: Option<String>,
    /// API field.
    pub service: ExternalObjectService,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    /// API field.
    pub team: Option<String>,
    /// API field.
...
pub struct NodeField {
    #[serde(rename = "allowExpression")]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    /// Whether the field accepts expressions
    pub allow_expression: Option<bool>,
    ...
    pub options: Option<Vec<std::collections::BTreeMap<String, Value>>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct ProductKnowledgeReconcileFailure {
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct ProductKnowledgeReconcileResponse {
    ...
    pub failures: Vec<ProductKnowledgeReconcileFailure>,
    /// Customer keys whose agent tool config is converged.
    pub reconciled_customers: Vec<String>,
}
...
pub struct SandboxKey {
    ...
    pub key_hint: Option<Option<String>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct ScriptLanguageSpec {
    /// Builtin function docs
    pub builtins: Vec<std::collections::BTreeMap<String, Value>>,
    /// Language keywords
    ...
    pub namespaces: Vec<std::collections::BTreeMap<String, Value>>,
    /// Language operators
    pub operators: Vec<String>,
    #[serde(rename = "reservedNames")]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    /// Names that cannot be rebound
    pub reserved_names: Option<Vec<String>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    /// Editor snippet templates
    pub snippets: Option<Vec<std::collections::BTreeMap<String, Value>>>,
    #[serde(rename = "specialIdentifiers")]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    /// Special symbols such as JSONPath root/current
    pub special_identifiers: Option<Vec<std::collections::BTreeMap<String, Value>>>,
    #[serde(rename = "typeDefinitions")]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    /// Named type definitions (event interfaces, etc.) with fields
    pub type_definitions: Option<Vec<std::collections::BTreeMap<String, Value>>>,
    #[serde(rename = "typeSystem")]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    /// Type-system primitives, generics, annotations, inference, and runtime-check guidance
    pub type_system: Option<std::collections::BTreeMap<String, Value>>,
    /// Schema version
    pub version: i64,
}
...
pub struct ScriptTestCase {
    ...
    pub assertions: Option<Vec<ScriptTestAssertion>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
///
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct ScriptTestOutputEntry {
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct ScriptTestSuite {
    ...
    pub tests: Option<Vec<ScriptTestCase>>,
}

/// Schema for the result of running a ScriptTest
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct ScriptTestRunResult {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    /// Total number of `test.expect(...)` matcher calls that ran
    pub assertion_count: Option<i64>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    pub output: Option<Vec<ScriptTestOutputEntry>>,
    /// True when every test in every suite passed
    pub passed: bool,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    /// One entry per describe path
    pub suites: Option<Vec<ScriptTestSuite>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub enum SlackDeliveryOutcomeOperation {
    ...
    #[serde(rename = "post")]
    Post,
    /// The post_ephemeral wire value.
    #[serde(rename = "post_ephemeral")]
    PostEphemeral,
...
pub struct SolutionInstance {
    ...
    pub attachment_ref: Option<Option<std::collections::BTreeMap<String, Value>>>,
...
pub struct Task {
    ...
    pub aggregate_version: Option<Option<i64>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    pub created_by_actor: Option<Option<Actor>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    pub current_lease: Option<Option<TaskSessionLeaseSummary>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    pub owner_actor: Option<Option<Actor>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct TeamMembership {
    ...
    pub team: Option<Option<std::collections::BTreeMap<String, Value>>>,
    #[serde(rename = "type")]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct Trajectory {
    ...
    pub messages: Option<Vec<std::collections::BTreeMap<String, Value>>>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
